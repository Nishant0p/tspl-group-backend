...
export interface ApiApplicantApplicant extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Job applications submitted from frontend';
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  collectionName: 'jobs';
  info: {
    description: 'Published and draft job postings';
    displayName: 'Job';
    pluralName: 'jobs';
    singularName: 'job';
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rcsTemplateCode: Schema.Attribute.String;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contact-us inquiries';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
